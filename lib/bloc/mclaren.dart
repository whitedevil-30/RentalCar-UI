...
import 'package:rentalcar/bloc/ferrari.dart';
import 'package:rentalcar/bloc/home_page.dart';
import 'package:rentalcar/models/car.dart';
import 'package:carousel_slider/carousel_slider.dart';

var currentCar = carList.cars[3];

class MyMclaren extends StatelessWidget {
  const MyMclaren({super.key});
      ...
      appBar: AppBar(
        ...
        leading: Container(
            ...
            child: IconButton(
              ...
              .push(MaterialPageRoute(builder: (context) => const MyFerrari())),
              icon: Icon(
                Icons.arrow_back,
                color: Colors.white,
              ),
